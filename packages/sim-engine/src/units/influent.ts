...
const parameterSchema: ParameterField[] = [
  ...
  { key: 'BOD5', label: 'BOD₅', unit: 'mg/L', min: 0, max: 1000, step: 10, defaultValue: 250, advanced: true },
  { key: 'NH3N', label: 'NH₃-N', unit: 'mgN/L', min: 0, max: 150, step: 1, defaultValue: 25, advanced: true },
  { key: 'NO3N', label: 'NO₃-N', unit: 'mgN/L', min: 0, max: 50, step: 0.1, defaultValue: 0.5, advanced: true },
  { key: 'TP', label: 'Total P', unit: 'mgP/L', min: 0, max: 50, step: 0.5, defaultValue: 8, advanced: true },
  { key: 'TSS', label: 'TSS', unit: 'mg/L', min: 0, max: 2000, step: 10, defaultValue: 250, advanced: true },
  { key: 'VSS', label: 'VSS', unit: 'mg/L', min: 0, max: 1500, step: 10, defaultValue: 200, advanced: true },
  { key: 'pH', label: 'pH', unit: '', min: 4, max: 10, step: 0.1, defaultValue: 7.2, advanced: true },
  { key: 'alkalinity', label: 'Alkalinity', unit: 'mmol/L', min: 0, max: 20, step: 0.5, defaultValue: 5, advanced: true },
  { key: 'DO', label: 'DO', unit: 'mg/L', min: 0, max: 10, step: 0.1, defaultValue: 0, advanced: true },
  { key: 'temperature', label: 'Temperature', unit: '°C', min: 0, max: 40, step: 0.5, defaultValue: 20, advanced: true },
];
